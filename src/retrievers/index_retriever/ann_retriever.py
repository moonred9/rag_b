...
class AnnIndexRetriever(BaseRetriever):
    ...
    def _get_nodes_with_embeddings(
        ...
        query_result = self._get_milvus_query(query,self._vector_store.doc_id_field, self._vector_store.text_key, self._vector_store.collection_name, **self._kwargs)
    ...
    def _get_milvus_query(self, query: VectorStoreQuery, doc_id_field, text_key, collection_name, **kwargs: Any) -> VectorStoreQueryResult:
