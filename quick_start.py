...
from src.retrievers import BaseRetriever, CustomBM25Retriever, EnsembleRetriever, EnsembleRerankRetriever, HNSWRetriever, IVF_FlatRetriever, IVF_SQ8Retriever, IVF_PQRetriever, SCANNRetriever, DISKANNRetriever, FlatRetriever
from src.embeddings.base import HuggingfaceEmbeddings

parser = argparse.ArgumentParser()

# Model related options
parser.add_argument('--model_name', default='gpt-3.5-turbo', help="Name of the model to use")
...
parser.add_argument('--retriever_name', default="flat", help="Name of the retriever")
...
parser.add_argument('--if_llm', default=False, help="Whether to use llm")
parser.add_argument('--is_create_vector_index', default=True, help="Whether to create vector index in milvus collection")
...
# embed_model = FlagModel('BAAI/bge-large-zh-v1.5', 
...
elif args.retriever_name == "hnsw":
    retriever = HNSWRetriever(
        args.docs_path, embed_model=embed_model, embed_dim=args.embedding_dim,
        chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap,
        construct_index=args.construct_index, add_index=args.add_index,
        collection_name=args.collection_name, similarity_top_k=args.retrieve_top_k,
        is_create_vecor_index=args.is_create_vector_index
    )
elif args.retriever_name == 'ivf_flat':
    retriever = IVF_FlatRetriever(
        args.docs_path, embed_model=embed_model, embed_dim=args.embedding_dim,
        chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap,
        construct_index=args.construct_index, add_index=args.add_index,
        collection_name=args.collection_name, similarity_top_k=args.retrieve_top_k,
...
elif args.retriever_name == 'ivf_sq8':
    retriever = IVF_SQ8Retriever(
        args.docs_path, embed_model=embed_model, embed_dim=args.embedding_dim,
        chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap,
        construct_index=args.construct_index, add_index=args.add_index,
        collection_name=args.collection_name, similarity_top_k=args.retrieve_top_k,
...
elif args.retriever_name == 'ivf_pq':
    retriever = IVF_PQRetriever(
        args.docs_path, embed_model=embed_model, embed_dim=args.embedding_dim,
        chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap,
        construct_index=args.construct_index, add_index=args.add_index,
        collection_name=args.collection_name, similarity_top_k=args.retrieve_top_k,
...
elif args.retriever_name == 'scann':
...
elif args.retriever_name == 'diskann':
    retriever = DISKANNRetriever(
        args.docs_path, embed_model=embed_model, embed_dim=args.embedding_dim,
        chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap,
        construct_index=args.construct_index, add_index=args.add_index,
        collection_name=args.collection_name, similarity_top_k=args.retrieve_top_k,
